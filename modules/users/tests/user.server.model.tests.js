...
describe('User Model Unit Tests:', function () {
  ...
  describe('Method Save', function () {
    ...
    it('should not save the passphrase in plain text', function (done) {
      var _user1 = new User(user1);
      _user1.password = 'Open-Source Full-Stack Solution for NodeApp';
      var passwordBeforeSave = _user1.password;
      _user1.save(function (err) {
        should.not.exist(err);
        _user1.password.should.not.equal(passwordBeforeSave);
  ...
  describe('User Password Validation Tests', function () {
    ...
    it('should validate when the passphrase strength passes - "Open-Source Full-Stack Solution For NodeApp Applications"', function () {
      var _user1 = new User(user1);
      _user1.password = 'Open-Source Full-Stack Solution For NodeApp Applications';
